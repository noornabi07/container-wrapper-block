...
class CTRBContainerBlock{
	...
	function render( $attributes, $innerBlocks ){
		...
		$class = $class ?? '';
		$blockClass = "wp-block-ctrb-container $class align$align";
		...
		<div class='<?php echo esc_attr( $blockClass ); ?>' id='wrapper-<?php echo esc_attr( $cId ) ?>' data-attributes='<?php echo esc_attr( wp_json_encode( $attributes ) ); ?>'>
				<?php 
    ...
    <div class="mainDiv">
		...
		<!-- Top shaped section here -->
            ...
            if ($topShaped === 'ocean wave') {
                echo '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1000 100" preserveAspectRatio="none"><g clipPath="url(#eb-shape-divider-ocean-wave)"><path class="eb-shape-divider-fill" fill="' . $topColors . '" d="M0 97.79S101.82-.97 283.17 5.23c203.09 0 290.46 94.4 716.83 94.4V0H0v97.79Z"></path></g><defs><clipPath id="eb-shape-divider-ocean-wave"><path fill="#fff" class="eb-shape-divider-fill" d="M0 0h1000v99.62H0z"></path></clipPath></defs></svg>';
				...
				fill="'.$topColors.'" /></g><defs><clipPath id="eb-shape-divider-triangle"><path class="eb-shape-divider-fill" d="M0 0h1000v98.99H0z" fill="currentColor"/>
			</clipPath></defs></svg>';
           ...
           <div class="bottom-shaped">
            <?php
             if ($bottomShaped === 'ocean wave') {
                echo '<svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1000 100" preserveAspectRatio="none"><g clipPath="url(#eb-shape-divider-ocean-wave)"><path class="eb-shape-divider-fill" fill="'.$bottomColors.'" d="M0 97.79S101.82-.97 283.17 5.23c203.09 0 290.46 94.4 716.83 94.4V0H0v97.79Z"></path></g><defs><clipPath id="eb-shape-divider-ocean-wave"><path fill="#fff" class="eb-shape-divider-fill" d="M0 0h1000v99.62H0z"></path></clipPath></defs></svg>';
